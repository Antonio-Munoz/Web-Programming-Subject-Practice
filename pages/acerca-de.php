...
<body class="body-bg-color" onload="aboutUs()">
      ...
      <div class="container my-5">
        <div class="row">
          <div class="col-md-12 text-center text-white d-flex flex-column align-items-center justify-content-center">
            <p class="paragraph-style mt-3">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit quos aperiam sapiente eveniet, similique quis omnis itaque cupiditate optio animi officia assumenda quae laboriosam, mollitia dignissimos quisquam dolor? Quaerat, architecto?
            </p>
            <iframe class="pdf-size" src="../pdf/CV Erick Antonio Muñoz Meza.pdf" height="100%" width="100%"></iframe>
          </div>
        </div>
      </div>
