                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="../admin-page.php" class="btn btn-danger">
                                                <i class="bi bi-chevron-left"></i>
                                                Volver
                                            </a>
                                        </div>
                                    </div>
                                    <h3 class="text-center font-weight-light mb-4">Agregar usuario</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    <form action="crud-admin.php" method="post" enctype="multipart/form-data"> 
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><input id="update-admin" name="update-admin" value="Actualizar" type="submit" class="btn btn-success btn-block"/></div>
                                        </div>
                                    </form>
